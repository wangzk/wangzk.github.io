...
last_modified_at: 2024-05-16 15:36:00 +08:00
categories: teaching
show_tags: true
lang: zh-CN
---
...
1. 毕业论文的参考文献数量应在45篇及以上。
2. 建议插入3篇及以上的中文文献，中文文献应来自权威中文学术期刊，建议只考虑计算机学报、软件学报、计算机研究与发展、中国科学：信息科学等[CCF推荐中文T1类刊物](https://www.ccf.org.cn/ccftjgjxskwml/)。
...
如无特别说明，参考文献的格式默认遵循国家标准GB/T 7714—2015《信息与文献 参考文献著录规则》，关于该国家标准的描述可以参考[该页面](https://github.com/zepinglee/gbt7714-bibtex-style)的“参考文献著录标准”一节的内容。
...
- 也可以使用[在线小工具](https://www.bigan.net/reference/)根据人工输入的信息生成参考文献条目。
...
1. 图片应该插入高分辨率的图片，线条与文字不能模糊发虚。
2. 论文中的每一张图表都需要在正文中显式的引用（例如，如图X所示）。不能只插图或表而在论文中没有任何引用。

### 编号

- 因为论文的章节编号已经使用“1.”、“1.1“等形式，因此正文中的编号不要再使用上述形式，以免造成混淆。可以优先选用“（1）”、“（a）”等形式。
